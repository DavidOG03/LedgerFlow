    ...
    <section className="w-full relative px-4 pt-4 md:pt-10 bg-linear-to-b from-bg via-bg to-accent/20">
      ...
      <div className="sticky top-[15vh] w-full flex flex-col items-center justify-center z-0">
        ...
        <img
          ...
          decoding="async"
          alt="grid pattern"
          className="absolute hidden md:block -top-20 right-0 mix-blend-soft-light opacity-10 brightness-75 filter contrast-75 scale-1.2 dark:opacity-100 pointer-events-none z-[-1]"
        />
